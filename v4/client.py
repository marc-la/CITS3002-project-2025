        ...
        try:
            while not self.game_over_event.is_set():
                ...
                if line == "GAME_START":
                    ...
                    self.is_spectator_event.clear()  # Clear the spectator event
                elif line == "DISCONNECT":
                    self.game_over_event.set()
                    break
                elif line == "YOUR_TURN":
                    self.input_timer.set()  # Set the input timer event
                elif line == "GRID":
